...
if __name__ == '__main__':
    ...
    # root_path = 'D:/137/dataset/VAD/ShanghaiTech/my_features/I3D-10crop/Train/'
    root_path = 'D:/137/dataset/VAD/ShanghaiTech/my_features/I3D-10crop/Test/'
    ...
    abnormal_files = [os.path.splitext(os.path.basename(ab_file))[0] for ab_file in abnormal_files]
    # abnormal_files = [os.path.splitext(os.path.basename(ab_file))[0] + '_i3d' for ab_file in abnormal_files]

    count = 0
    # with open('./list/my_shanghai-i3d-train-10crop.list', 'w+') as f:
    with open('./list/my_shanghai-i3d-test-10crop.list', 'w+') as f:
