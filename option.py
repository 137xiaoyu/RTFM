...
# parser.add_argument('--ckpt', default='./ckpt/ucf270-i3d-83.815.pkl', type=str, help='ckpt for pretrained model')
# parser.add_argument('--ckpt', default='./ckpt/ucf410-i3d-84.289.pkl', type=str, help='ckpt for pretrained model')
# parser.add_argument('--ckpt', default='./ckpt/my_sht8980-i3d-97.262.pkl', type=str, help='ckpt for pretrained model')
parser.add_argument('--ckpt', default='./ckpt/my_ucf245-i3d-85.181.pkl', type=str, help='ckpt for pretrained model')
parser.add_argument('--num-classes', type=int, default=1, help='number of class')
parser.add_argument('--dataset', default='my_ucf', help='dataset to train on (default: )')
